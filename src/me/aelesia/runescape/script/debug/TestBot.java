...
//		this.taskMap.put(State.TRAVEL_OAK, new TravelDefault(Zones.DRAYNOR_OAKS.area) {			
//			@Override
//			public String stateIfArrived() {
//				return State.TRAVEL_BANK;
//			}
//		});
//		this.taskMap.put(State.TRAVEL_BANK, new TravelDefault(Zones.DRAYNOR_OAKS_2_EMPTY.area) {			
//			@Override
//			public String stateIfArrived() {
