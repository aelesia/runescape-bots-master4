...
public class FightingBot extends StateBot {
...
//		config.monstersToFight = new String[] { E.NPC.COW, E.NPC.COW_CALF, E.NPC.FARMER };
		config.monstersToFight = null;
		config.itemsToLoot = new String[] { E.Item.BONES };
